...
const {ServiceContacts,ServiceDetailsProtocol,ServiceState,ServiceDetails,User,UserInfo,UserEduPersonEntitlement,ServiceMultiValued,ServicePetitionDetails,Service,Petition,ServiceList} = require('./repos');
