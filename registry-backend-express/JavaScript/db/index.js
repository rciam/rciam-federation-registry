...
const {ServiceContacts,ServiceDetailsProtocol,Invitation,Tenants,ServiceState,Group,ServiceDetails,Tokens,User,UserInfo,UserRole,UserEduPersonEntitlement,ServiceMultiValued,ServicePetitionDetails,Service,Petition,ServiceList} = require('./repos');
