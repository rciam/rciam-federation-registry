...
const {ServiceContacts,ServiceDetailsProtocol,Invitation,Tenants,DeploymentResults,ServiceState,Group,ServiceDetails,DeployerAgents,Tokens,User,UserInfo,UserRole,UserEduPersonEntitlement,ServiceMultiValued,ServicePetitionDetails,Service,Petition,ServiceList} = require('./repos');
...
const initOptions = {
    ...
    extend(obj, dc) {
        ...
        obj.deployment_results = new DeploymentResults(obj,pgp);
