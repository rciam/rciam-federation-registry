...
class ServiceRepository {
  ...
  async getAll(tenant,filters,authorized){
    let filter_strings = {
      ...
      'access_token_validity_seconds',sd.access_token_validity_seconds,'access_token_validation_model',sd.access_token_validation_model,'refresh_token_validity_seconds',sd.refresh_token_validity_seconds,'refresh_token_validity_seconds',sd.refresh_token_validity_seconds,'client_secret',sd.client_secret,\
