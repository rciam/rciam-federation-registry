    ...
    FROM (SELECT *
      FROM (
        ...
        SELECT id,null as client_id, null as allow_introspection, null as code_challenge_method, null as device_code_validity_seconds, null as access_token_validity_seconds,
         null as refresh_token_validity_seconds, null as client_secret, null as reuse_refresh_tokens, null as jwks, null as jwks_uri, null as token_endpoint_auth_method,
