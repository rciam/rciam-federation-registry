SELECT DISTINCT name,preferred_username as username, email, group_manager,group_id,sub,service_details.id as service_id,service_petition_details.id as petition_id
FROM
