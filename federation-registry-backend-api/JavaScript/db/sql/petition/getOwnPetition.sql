SELECT json_build_object('service_name', sd.service_name,'service_description',sd.service_description,
						 ...
						 ,'entity_id',sd.entity_id,'organization_name',sd.name,'organization_url',sd.url,
						 'requester',sd.requester,'service_id',sd.service_id,'type',sd.type,'status',sd.status,'reviewed_at',sd.reviewed_at,'aup_uri',sd.aup_uri,
