  ...
  return(
    <React.Fragment>
      ...
      <dl className="dl-horizontal">
        <dt>
          <span className="text-info">{strings.user_info_claim_name}</span>
        </dt>
        <dd>
          <span className="text-info">{strings.user_info_claim_name}</span>
        </dd>
        <dt>
          <span className="dl-text-info">{strings.user_sub}</span>
        </dt>
        <dd>
          <span className="dl-text-info">{props.user.sub}</span>
        </dd>
        <dt>
          <span className="dl-text-info">{strings.user_info_name}</span>
        </dt>
        <dd>
          <span className="dl-text-info">{props.user.name}</span>
        </dd>
        <dt>
          <span className="dl-text-info">{strings.user_info_given_name}</span>
        </dt>
        <dd>
          <span className="dl-text-info">{props.user.given_name}</span>
        </dd>
        <dt>
          <span className="dl-text-info">{strings.user_info_family_name}</span>
        </dt>
        <dd>
          <span className="dl-text-info">{props.user.family_name}</span>
        </dd>
        <dt>
          <span className="dl-text-info">{strings.user_info_email}</span>
        </dt>
        <dd>
          <span className="dl-text-info">{props.user.email}</span>
        </dd>
        <dt>
          <span className="dl-text-info">{strings.user_info_acr}</span>
        </dt>
        <dd>
        ...
        <dt>
          <span className="dl-text-info">{strings.user_info_edu_person_unique_id}</span>
        </dt>
        <dd>
          <span className="dl-text-info">{props.user.sub}</span>
        </dd>
