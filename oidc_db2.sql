DROP TABLE IF EXISTS user_edu_person_entitlement, user_info, service_petition_contacts, service_petition_oidc_grant_types, service_petition_oidc_redirect_uris, service_petition_scopes, service_petition_details, service_scopes,service_contacts,service_oidc_grant_types,service_oidc_redirect_uris,service_details;
...
create table service_contacts (
  ...
  value VARCHAR(256),
  type VARCHAR(256),
  FOREIGN KEY (owner_id) REFERENCES service_details(id)
);
...
create table service_petition_contacts (
  ...
  value VARCHAR(256),
  type VARCHAR(256),
  FOREIGN KEY (owner_id) REFERENCES service_petition_details(id)
);
...
create table service_petition_scopes (
  id SERIAL PRIMARY KEY,
  owner_id bigint,
  value VARCHAR(256),
  FOREIGN KEY (owner_id) REFERENCES service_petition_details(id)
...
INSERT INTO service_details (client_description,reuse_refresh_tokens,allow_introspection,client_id,client_secret,access_token_validity_seconds,refresh_token_validity_seconds,client_name,logo_uri,policy_uri,clear_access_tokens_on_refresh,code_challenge_method,device_code_validity_seconds,integration_environment,requester,deployed,protocol)
...
INSERT INTO service_scopes(owner_id,value)
...
INSERT INTO service_petition_details (client_description,reuse_refresh_tokens,allow_introspection,client_id,client_secret,access_token_validity_seconds,refresh_token_validity_seconds,client_name,logo_uri,policy_uri,clear_access_tokens_on_refresh,code_challenge_method,device_code_validity_seconds,integration_environment,requester,status,service_id,reviewed_at,protocol)
...
INSERT INTO service_petition_details (client_description,reuse_refresh_tokens,allow_introspection,client_id,client_secret,access_token_validity_seconds,refresh_token_validity_seconds,client_name,logo_uri,policy_uri,clear_access_tokens_on_refresh,code_challenge_method,device_code_validity_seconds,integration_environment,requester,type,service_id,protocol)
...
INSERT INTO service_petition_details (client_description,reuse_refresh_tokens,allow_introspection,client_id,client_secret,access_token_validity_seconds,refresh_token_validity_seconds,client_name,logo_uri,policy_uri,clear_access_tokens_on_refresh,code_challenge_method,device_code_validity_seconds,integration_environment,requester,type,protocol)
...
INSERT INTO service_petition_details (service_id,requester,type,protocol) VALUES (1,'4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@egi.eu','delete','oidc');
...
INSERT INTO service_petition_scopes(owner_id,value)
VALUES ('1','electroscope');
INSERT INTO service_petition_scopes(owner_id,value)
VALUES ('2','microscope');
INSERT INTO service_petition_scopes(owner_id,value)
